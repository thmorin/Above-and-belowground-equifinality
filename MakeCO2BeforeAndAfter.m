...
if mmm==1
    ylabel({'NEE','(μmol m^{-2} s^{-1})'},'FontSize',11);
else
    yticklabels('');
end
if mmm==1
    text(2,-3,'g)','FontSize',11);
elseif mmm==2
    text(2,-3,'h)','FontSize',11);
else
    text(2,-3,'i)','FontSize',11);
end
...
if mmm==1
    ylabel({'R_E','(μmol m^{-2} s^{-1})'},'FontSize',11);
else
    yticklabels('');
end
...
if mmm==1
    text(2,4,'d)','FontSize',11);
elseif mmm==2
    text(2,4,'e)','FontSize',11);
else
    text(2,4,'f)','FontSize',11);
end
...
ylim([0 35]);
if mmm==1
    ylabel({'GPP','(μmol m^{-2} s^{-1})'},'FontSize',11);
    title('July');
elseif mmm==2
    yticklabels('');
    title('Aug.');
...
if mmm==1
    text(2,25,'a)','FontSize',11);
elseif mmm==2
    text(2,25,'b)','FontSize',11);
else
    text(2,25,'c)','FontSize',11);
end
...
if mmm==1
    text(2,.015,'j)','FontSize',11);
elseif mmm==2
    text(2,.015,'k)','FontSize',11);
else
    text(2,.015,'l)','FontSize',11);
end
...
if mmm==1
    text(2,-.4,'m)','FontSize',11);
elseif mmm==2
    text(2,-.4,'n)','FontSize',11);
else
    text(2,-.4,'o)','FontSize',11);
end
