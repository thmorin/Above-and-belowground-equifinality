      ...
      SUBROUTINE grosub_EQF(I,J,NHW,NHE,NVN,NVS)
C
...
C     DIMENSION VCO2(400,366,05)
     ...
     2,RTLGAX=1.0E-03,EMODR=5.0)
      PARAMETER(CURV=0.70,CURV2=2.0*CURV,CURV4=4.0*CURV
     ...
     2,FRTX=1.0/(1.0-(1.0-FSTK)**2))
      ...
      PARAMETER(EN2F=0.20,SPNDL=1.0E-02
...
!------------------------TIM MOD---------------
      QNTM=0.45
      VMXO=0.125
!      write(*,*)'APPLIED QNTM_MULT grosub_EQF.f',QNTM_MULT
!      QNTM=0.45*QNTM_MULT
!      write(*,*)'APPLIED VMXO_MULT',VMXO_MULT
...
C
      ...
      ENDIF
!-----------TIM MOD----------------
!      WRITE(*,*)'PTSHT in Grosub=',PTSHT(NZ,NY,NX)
!-----------END MOD-----------------
