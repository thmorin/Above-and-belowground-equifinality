      ...
      SUBROUTINE readq_EQF(NA,ND,NT,NE,NAX,NDX,NTX,NEX,NF,NFX,NTZ
...
!------------------TIM MOD---------------
!      write(*,*)'MOD XKO2 MULT APPLIED READQ_EQF.F',XKO2_MULT
!      XKO2(NZ,NY,NX)=XKO2(NZ,NY,NX)*XKO2_MULT
      !write(*,*)'MOD XKCO2 MULT APPLIED READQ_EQF.F',XKCO2_MULT
      !write(*,*)'OLD XKCO2',XKCO2(NZ,NY,NX)
      XKCO2(NZ,NY,NX)=XKCO2(NZ,NY,NX)*XKCO2_MULT
      !write(*,*)'NEW XKCO2',XKCO2(NZ,NY,NX)
!      write(*,*)'MOD VOMX MULT APPLIED READQ_EQF.F',VOMX_MULT
!      VOMX(NY,NY,NX)=VOMX(NZ,NY,NX)*VOMX_MULT
!      write(*,*)'MOD VCMX4 MULT APPIED READQ_EQF.F',VCMX4_MULT
!      VCMX4(NZ,NY,NX)=VCMX4(NZ,NY,NX)*VCMX4_MULT
!      write(*,*)'MOD VCMX MULT APPIED READQ_EQF.F',VCMX_MULT
      VCMX(NZ,NY,NX)=VCMX(NZ,NY,NX)*VCMX_MULT
!      write(*,*)'MOD ETMX_MULT APPLIED READQ_EQF.F',ETMX_MULT
!      write(*,*)'OLD ETMX',ETMX(NZ,NY,NX)
      ETMX(NZ,NY,NX)=ETMX(NZ,NY,NX)*ETMX_MULT
!      write(*,*)'NEW ETMX',ETMX(NZ,NY,NX)
!------------------END MOD---------------
...
!-------------------------------TIM MOD---------------------------
!      write(*,*)'OLD PTSHT VALUE:',PTSHT(NZ,NY,NX),NZ,NY,NX
      PTSHT(NZ,NY,NX)=PTSHT(NZ,NY,NX)*phl_mult
!      write(*,*)'TIM: Executed phloem multiplier',phl_mult
!      write(*,*)'NEW PTSHT VALUE:',PTSHT(NZ,NY,NX),NZ,NY,NX
!-------------------------------END MOD---------------------------
C
...
!-------------------------------TIM MOD---------------------------
!      write(*,*)'OLD OSMO VALUE:',OSMO(NZ,NY,NX),NZ,NY,NX
      OSMO(NZ,NY,NX)=OSMO(NZ,NY,NX)*osm_mult
!      write(*,*)'TIM: Executed OSMO multiplier',osm_mult
!      write(*,*)'NEW OSMO VALUE:',OSMO(NZ,NY,NX),NZ,NY,NX
!-------------------------------END MOD---------------------------
