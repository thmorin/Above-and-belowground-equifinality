      SUBROUTINE nitro_eqf(I,J,NHW,NHE,NVN,NVS)
C
...
C
     ...
     2,BIOA=BIOS*12.57*ORAD**2,RCCX=0.833
...
C
      PARAMETER (VMXF=0.125,VMXM=0.125,VMXH=0.375
     2,VMXN=0.25,VMX4=0.375,VMXC=0.125,OQKA=1.2E+01
...
C
      PARAMETER (HSORP=1.0,DOSA=0.5,DOSX=5.0E-03)
C
C     SPECIFIC DECOMPOSITION RATES
C
      PARAMETER (RMOM=0.010)
...
!      write(*,*)'APPLIED DCKML_MULT NITRO.F',DCKML_MULT
!      DCKML=1000*DCKML_MULT
      DCKML=1000
!      write(*,*)'APPLIED DCKM0_MULT NITRO.F',DCKM0_MULT
!      DCKM0=5000*DCKM0_MULT
      DCKM0=5000
!      write(*,*)'APPLIED VMXO_MULT NITRO.F',VMXO_MULT
!      write(*,*)'PREVIOUS VMXO',VMXO
      VMXO=0.125*VMXO_MULT
!      write(*,*)'AFTER VMXO',VMXO
!      VMXO=0.125
!      write(*,*)'APPLIED OQKM_MULT',OQKM_MULT
!      write(*,*)'OLD OQKM',OQKM
      OQKM=12*OQKM_MULT
!      write(*,*)'NEW OQKM',OQKM
!      write(*,*)'APPLIED TSORP_MULT',TSORP_MULT
      TSORP=0.5
!      TSORP=0.5*TSORP_MULT
!      write(*,*)'APPLIED SPOHA_MULT',SPOHA_MULT
      SPOHA=0.25
!      SPOHA=0.25*SPOHA_MULT
!      write(*,*)'APPLIED DCKI_MULT',DCKI_MULT
      DCKI=2.5*DCKI_MULT
!      write(*,*)'APPLIED SPOHC_MULT',SPOHC_MULT
!      write(*,*)'OLD SPOHC',SPOHC
      SPOHC=0.25*SPOHC_MULT
!      write(*,*)'NEW SPOHC',SPOHC
!-------------MOD END----------------------
...
!      write(*,*)'ACTUALLY CONSIDERING SPOHC'
!      write(*,*)'OHC',OHC(K,L,NY,NX)
!      write(*,*)'TERM W SPOHC'
