...
C
!-----------TIM MOD----------------
! If this line is on you have thermokarst enabled. Line below is to turn it off
      IF(ABS(DVOLI(LX,NY,NX)).GT.ZEROS(NY,NX))THEN !TURNED ON
!      IF(ABS(DVOLI(LX,NY,NX)).GT.1.0E+12)THEN !TURNED OFF
